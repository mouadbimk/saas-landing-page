    ...
    <div className="w-full border-b border-(--border-color) pt-3">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <button className="bg-white  border border-white px-4 py-2 rounded-md cursor-pointer duration-600 transition-all group-hover:border-slate-200 hover:border-(--color-primary)">
            <span className="text-gradient">Sing in</span>
          </button>
          <button
            className="flex items-center gap-1 bg-(--color-primary) hover:bg-(--color-primary_hover) transition-all duration-500 text-slate-100 border border-(--color-primary) px-4 py-2 rounded-md cursor-pointer"
            ...
            <div className="flex-1 h-full px-6 py-6">
              ...
              <ul className="flex flex-col gap-1 mt-5">
                <li className="group/item cursor-pointer p-1 rounded-lg transition-all duration-300 hover:bg-slate-50">
                  <a
                    href="#"
                    className="text-[15px] font-semibold text-violet-600 group-hover/item:text-violet-500 duration-300 transition-colors"
                  >
                    Payments
                  </a>
